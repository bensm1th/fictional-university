...
//     }
//
//     let newRequestNote = await fetch(`${bullseyeData.root_url}/wp-json/wp/v2/note/`, {
//       method: 'POST',
//       headers: {
//         'X-WP-Nonce': bullseyeData.nonce,
//         'Accept': 'application/json',
//         'Content-Type': 'application/json'
//       },
//       body: JSON.stringify(ourNewPost)
//     });
//     const response = await newRequestNote.json();
...
//     }
//     const editRequestNote = await fetch(`${bullseyeData.root_url}/wp-json/wp/v2/note/${thisNote.data('id')}`, {
//       method: 'POST',
//       headers: {
//         'X-WP-Nonce': bullseyeData.nonce,
//         'Accept': 'application/json',
...
//     });
//     const response = await editRequestNote.json();
//     this.makeNoteReadOnly(thisNote);
//   }
//
//   async deleteNote(e) {
//     const thisNote = $(e.target).parents("li");
//     const deleteRequestNote = await fetch(`${bullseyeData.root_url}/wp-json/wp/v2/note/${thisNote.data('id')}`, {
//       method: 'DELETE',
//       headers: {'X-WP-Nonce': bullseyeData.nonce}
//     });
//     thisNote.slideUp();
//     console.log(deleteRequestNote);
//   }
//
//   makeNoteEditable(thisNote) {
//     thisNote.find(".edit-note").html('<i class="fa fa-times" arria-hidden="true"></i> Cancel');
...
//     thisNote.find(".edit-note").html('<i class="fa fa-pencil" arria-hidden="true"></i> Edit');
...
class MyNotes {
  ...
  async deleteNote(e) {
    ...
    try {
      const response = await axios.delete(bullseyeData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"))
      console.log(response);
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios.post(bullseyeData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"), ourUpdatedPost)
      this.makeNoteReadOnly(thisNote)
    } catch (e) {
      console.log("Sorry")
    }
  ...
  async createNote() {
    ...
    try {
      const response = await axios.post(bullseyeData.root_url + "/wp-json/wp/v2/note/", ourNewPost)
